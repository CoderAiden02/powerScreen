...
<template>
  <svg id="yichang" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="456" height="127" viewBox="0 0 456 127">
    <defs>
      <linearGradient id="ad-linear-gradient" x1="432" y1="61.625" x2="2" y2="61.625" gradientUnits="userSpaceOnUse">
      ...
      <linearGradient id="ad-linear-gradient-2" x1="432" y1="61.625" x2="2" y2="61.625" gradientUnits="userSpaceOnUse">
      ...
      <filter id="ad-filter" filterUnits="userSpaceOnUse">
    ...
    <path id="curve_right" class="ad-cls-1"
    ...
    <path id="curve" class="ad-cls-2"
      d="M2.006,86.083H31.461l3.006-9.664,4.208,13.288,4.208-10.268,3.006,6.644H73.541l4.208-10.872L83.76,103l7.871-82.748,10.163,71.876,3.607-6.644h11.421l3.607,13.892L124.637,72.8l5.41,20.536,3.006-7.852h46.888l4.208-15.7,6.011,28.388,5.41-19.932,4.208,7.248h37.815L241,76l4,14,5-11,3,6h27l4-11,6,29,10-69,8,57,3-6h13l3,14,4-27,6,20,2-7h46l6-16,5,29,7-20,4,7h25" />
    <template v-for="(item, index) in dots" :key="item">
      <circle :id="`curve_d_${index + 1}`" class="ad-cls-3" cx="0" cy="0" :r="item.value">
...
.ad-cls-1 {
  opacity: 0.8;
  stroke: url(#ad-linear-gradient);
}

.ad-cls-2 {
  stroke: url(#ad-linear-gradient-2);
}

.ad-cls-3 {
  will-change: opacity;
  fill: #f98800;
  filter: url(#ad-filter);
}
</style>